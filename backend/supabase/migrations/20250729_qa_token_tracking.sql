...
CREATE INDEX idx_qa_token_usage_validation_run ON qa_token_usage(validation_run_id);
CREATE INDEX idx_qa_token_usage_created_at ON qa_token_usage(created_at);
