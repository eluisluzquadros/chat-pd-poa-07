...
const Logos3 = ({
  ...
  return <section className="py-0">
      <div className="container flex flex-col items-center text-center">
        <h2 className="text-pretty text-2xl my-0 font-bold lg:text-2xl">
          {heading}
        </h2>
      </div>
        ...
        <div className="relative mx-auto flex items-center justify-center lg:max-w-5xl">
          ...
          speed: 0.7
            ...
            <CarouselContent className="ml-0">
              {logos.map(logo => <CarouselItem key={logo.id} className="flex basis-1/2 justify-center pl-0 sm:basis-1/3 md:basis-1/4 lg:basis-1/5">
                  <div className="mx-6 flex shrink-0 items-center justify-center">
                    <div>
                      <img src={logo.image} alt={logo.description} className={logo.className || "h-7 w-auto"} />
                    </div>
                  </div>
                </CarouselItem>)}
            </CarouselContent>
