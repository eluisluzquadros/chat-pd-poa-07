...
CREATE POLICY "Enable read for all users" ON regime_urbanistico 
    FOR SELECT USING (true);
    
CREATE POLICY "Enable read for all users" ON zots_bairros 
    FOR SELECT USING (true);
...
-- node scripts/convert-and-import-regime.mjs
-- =====================================================